...
# Ruta al archivo embeddings.csv en la carpeta models
file_name = os.path.join(os.path.dirname(os.path.abspath(__file__)), "models", "embeddings.csv")
...
if __name__ == "__main__":
    interface.launch(
        allowed_paths=[
            os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "data"),   # Directorio `data`
            os.path.join(os.path.dirname(os.path.abspath(__file__)), "models")                  # Directorio `models`
        ]
    )
